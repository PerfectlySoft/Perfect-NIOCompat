...
public enum OpenSSLVerifyMode {
	case sslVerifyNone, sslVerifyPeer, sslVerifyFailIfNoPeerCert
	case sslVerifyClientOnce, sslVerifyPeerWithFailIfNoPeerCert
	case sslVerifyPeerClientOnce, sslVerifyPeerWithFailIfNoPeerCertClientOnce
}
